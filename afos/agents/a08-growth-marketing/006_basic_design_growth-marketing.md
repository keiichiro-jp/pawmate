# A08 Growth Marketing Agent｜006 Basic Design
...
この基本設計は、A08 Growth Marketing AgentをPawMateの日次チケット運用へ組み込むためのプロンプト構造である。最終プロンプトは、役割、PawMate文脈、担当範囲、入出力契約、実行順、協働、安全、品質、出力テンプレートの10章で構成する。
