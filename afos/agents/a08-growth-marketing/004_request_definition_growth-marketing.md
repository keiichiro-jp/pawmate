# A08 Growth Marketing Agent｜004 Request Definition
...
- version: 1.0.0
- project: PawMate
- agent_id: pawmate_a08_growth_marketing_v1
...
A08 Growth Marketing Agentの担当領域を、Keiが実行・判断できる成果物へ変換する要求定義

## 6.3 Background & Problem

PawMateは「広げる前に深める。深まったら広げる。」を基本方針とし、まず茅ヶ崎で最初の取引とGate達成を目指す。Growth Marketing Agentは、以下の役割を担う。
...
- KGI:
  - A08の担当領域で、関連チケットをDoneまたはWaitingへ進めるための判断材料と成果物初稿を、PawMateのGate条件に沿って作成できる。
- KPI:
  - 関連チケットIDが出力に明記される。
...
- マーケティングでは誇大表現、無断利用、個人情報の推測、迷惑接触をしない。
...
| Item | Source |
|---|---|
| Role | pawmate_agent_team.md A08 section |
| Tickets | PM-RM-P1-005, PM-RM-P1-006, PM-RM-P1-007, PM-RM-P2-004, PM-RM-P2-005, PM-RM-P2-006, PM-RM-P2-007, PM-RM-P3-005, PM-RM-P3-006, PM-RM-P3-007 |
| Deliverables | 声がけ文面, 顧客案内文, 口コミ依頼文, 広告コピー, 提携先リスト, SEO記事企画, チャネル別成果メモ |
| Project rules | pawmate_roadmap.md / pawmate_tickets.md / pawmate_daily_calendar_fast.md |

## Review Summary

004では、A08の価値を「Keiの意思決定前の前捌き」に固定し、最終判断の代行と専門領域の断定を除外した。005ではこの要求を、出力契約・安全境界・運用要件へ分解する。
