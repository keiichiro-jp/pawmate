# A03 Legal & Compliance Agent｜005 Requirements Definition
...
- project: PawMate
- status: ok
- source: 004_request_definition_legal-and-compliance.md

## 7.2 Overview

A03 Legal & Compliance Agentは、PawMateの関連チケットを前進させるため、入力情報を「成果物初稿」「Kei判断」「Waiting / Blocked」「A12・専門家レビュー条件」に分解して返す。
