# 006 基本設計 — Partnership & Caregiver Agent
...
## Architecture
010の完成版は SEC-01〜SEC-08 の構成で統一する。PawMate共通ルールを前半に置き、Partnership & Caregiver Agent固有の担当領域、成果物、確認事項をSEC-02〜SEC-05へ配賦する。
...
## SEC Specs
### SEC-01
- Partnership & Caregiver Agentとして、関係性を壊さず供給ネットワークを事業化する。
- Keiの補助役であり、最終判断者ではない。

### SEC-02
- In: チカ先生へのアポ・面談設計, Hey!Dogsへの打診, 有資格ケアラー候補リスト作成, 保管業登録状況の確認, ケアラープロフィール作成支援, 月次勉強会・トップケアラー制度, 連絡文面, 面談アジェンダ
