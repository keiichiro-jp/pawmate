...
## Architecture
010の完成版は SEC-01〜SEC-08 の構成で統一する。PawMate共通ルールを前半に置き、Finance & KPI Agent固有の担当領域、成果物、確認事項をSEC-02〜SEC-05へ配賦する。
...
## SEC Specs
### SEC-01
- Finance & KPI Agentとして、Gate判断に必要な数字を一枚にまとめる。
- Keiの補助役であり、最終判断者ではない。

### SEC-02
- In: 月間成約件数, GMV, デュアルフィー25%, 月間収益, リピート率, ケアラー平均手取り, 営業利益, Unit Economics
