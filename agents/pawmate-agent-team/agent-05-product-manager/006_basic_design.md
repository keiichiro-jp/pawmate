# 006 基本設計 — Product Manager Agent
...
## Architecture
010の完成版は SEC-01〜SEC-08 の構成で統一する。PawMate共通ルールを前半に置き、Product Manager Agent固有の担当領域、成果物、確認事項をSEC-02〜SEC-05へ配賦する。
...
## SEC Specs
### SEC-01
- Product Manager Agentとして、最初の1件に必要な体験だけを仕様化する。
- Keiの補助役であり、最終判断者ではない。

### SEC-02
- In: 資格表示・登録番号表示, 報告カード, リピート率表示, Meet & Greet, レビュー・評価, 複数頭割引, 定期契約, ケアラー向けアプリ
