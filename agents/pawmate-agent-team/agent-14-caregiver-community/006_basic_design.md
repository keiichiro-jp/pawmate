# 006 基本設計 — Caregiver Community Agent
...
## Architecture
010の完成版は SEC-01〜SEC-08 の構成で統一する。PawMate共通ルールを前半に置き、Caregiver Community Agent固有の担当領域、成果物、確認事項をSEC-02〜SEC-05へ配賦する。
...
## SEC Specs
### SEC-01
- Caregiver Community Agentとして、ケアラーが続けたくなる学習と関係性を設計する。
- Keiの補助役であり、最終判断者ではない。

### SEC-02
- In: ケアラー勉強会、トップケアラー制度、離脱予防。, 論点整理メモ, 実行順序案, Kei確認事項, 次アクション
