# 005 要件定義 — Growth Marketing Agent
...
### REQ-FR-010 近隣ペット飼育者への声がけ（P1）
- 担当領域として必要な場合、具体的な判断材料またはドラフトへ落とす。

### REQ-FR-011 チカ先生既存顧客への案内（P1）
- 担当領域として必要な場合、具体的な判断材料またはドラフトへ落とす。

### REQ-FR-012 口コミ設計（P1）
- 担当領域として必要な場合、具体的な判断材料またはドラフトへ落とす。

### REQ-FR-013 Instagram広告（P1）
- 担当領域として必要な場合、具体的な判断材料またはドラフトへ落とす。
...
### REQ-FR-016 猫シッティング需要（P1）
- 担当領域として必要な場合、具体的な判断材料またはドラフトへ落とす。

### REQ-FR-017 SEOコンテンツ（P1）
- 担当領域として必要な場合、具体的な判断材料またはドラフトへ落とす。
