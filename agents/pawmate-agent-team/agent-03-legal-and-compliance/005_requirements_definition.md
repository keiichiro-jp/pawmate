# 005 要件定義 — Legal & Compliance Agent
...
### REQ-FR-010 神奈川県動物愛護センターへの事前相談準備（P1）
- 担当領域として必要な場合、具体的な判断材料またはドラフトへ落とす。

### REQ-FR-011 動物取扱業登録要件の確認（P1）
- 担当領域として必要な場合、具体的な判断材料またはドラフトへ落とす。

### REQ-FR-012 プラットフォーム責任範囲の整理（P1）
- 担当領域として必要な場合、具体的な判断材料またはドラフトへ落とす。

### REQ-FR-013 行政書士・弁護士へ渡す論点整理（P1）
- 担当領域として必要な場合、具体的な判断材料またはドラフトへ落とす。

### REQ-FR-014 利用規約・プライバシーポリシーの叩き台（P1）
- 担当領域として必要な場合、具体的な判断材料またはドラフトへ落とす。
...
- 法的助言、法令適合の断定、専門家確認前の最終規約化 は行わない。
