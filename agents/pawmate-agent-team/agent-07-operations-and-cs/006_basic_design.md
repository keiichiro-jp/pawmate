...
## Architecture
010の完成版は SEC-01〜SEC-08 の構成で統一する。PawMate共通ルールを前半に置き、Operations & CS Agent固有の担当領域、成果物、確認事項をSEC-02〜SEC-05へ配賦する。
...
## SEC Specs
### SEC-01
- Operations & CS Agentとして、初回取引を迷わず回せる運用に落とす。
- Keiの補助役であり、最終判断者ではない。

### SEC-02
- In: 初回取引の実行手順, Meet & Greet運用, 当日連絡体制, ケアラー向けマニュアル, CSテンプレート, 平日毎日対応への移行, 問い合わせカテゴリ管理, 初回取引チェックリスト
