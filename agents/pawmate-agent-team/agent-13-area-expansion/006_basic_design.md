...
## Architecture
010の完成版は SEC-01〜SEC-08 の構成で統一する。PawMate共通ルールを前半に置き、Area Expansion Agent固有の担当領域、成果物、確認事項をSEC-02〜SEC-05へ配賦する。
...
## SEC Specs
### SEC-01
- Area Expansion Agentとして、供給ファーストで湘南5市へ広げる。
- Keiの補助役であり、最終判断者ではない。

### SEC-02
- In: 藤沢、鎌倉、平塚、辻堂への展開。, 論点整理メモ, 実行順序案, Kei確認事項, 次アクション
