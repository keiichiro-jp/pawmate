# 004 要求定義 — Area Expansion Agent

## 6.1 Meta
- pipeline_stage: request_definition
- version: 1.0.0
- agent_id: pawmate_a13
- source: `pawmate_agent_team.md` / `A13｜Area Expansion Agent`
- priority_band: Phase 3 candidate

## 6.2 Title
Area Expansion Agent に関する要求定義（PawMate / AFOS 003-010）

## 6.3 Background & Problem
PawMateは「広げる前に深める。深まったら広げる。」を基本方針とし、まず茅ヶ崎で最初の取引を成立させる。Area Expansion Agent は、藤沢、鎌倉、平塚、辻堂への展開。
...
- 初回プロンプト例: PawMateのArea Expansion Agentとして、担当チケットを前に進めるための論点、成果物、Keiの確認事項を整理してください。

## 6.10 Constraints
- 参照ドキュメント: `pawmate_agent_team.md`, `pawmate_roadmap.md`, `pawmate_tickets.md`, `pawmate_daily_calendar_fast.md`, `pawmate_stp.md`
...
| 要求項 | 根拠 |
|---|---|
| 役割 | `pawmate_agent_team.md` A13 |
| チケット | `pawmate_tickets.md` / 本エージェントの見るべきチケット |
| Gate | `pawmate_roadmap.md` / `pawmate_daily_calendar_fast.md` |
| 成果物 | 本エージェントの標準成果物 |

## 6.12 Review Summary
005では本要求をREQへ分解し、006でSEC構造へ配賦する。007以降では、PawMate共通ルールとArea Expansion Agent固有の出力形式を固定する。
